        ...
        <td colspan="7">
          <table class="table table-striped table-condensed table-tight-vert" >
            ...
            <tbody>
              ...
              <tr>
                <th class="timetitle" >Avant 6 heure</th>
              ...
              <tr>
                ...
                <th class="timetitle" >{{: i <= 12 ? i : i - 12 }} {{: i < 12 ? "heure" : "heure"}}</th>
                <td class="time-{{: i}}-0"> </td>
              </tr>
              <tr>
                <th class="timetitle" >{{: i <= 12 ? i : i - 12 }}:30 {{: i < 12 ? "heure" : "heure"}}</th>
...
(function ($) {
  ...
  function calendar($el, options) {
    ...
    function draw() {
      ...
      $('.' + (new Date()).toDateCssClass()).addClass("Aujourd'hui");
